...
def mergeFeatureClasses():#arcpy.management.Merge(mfileList, r"D:\data\covid\MyProject.gdb\capstoneStates", '', "NO_SOURCE_INFO")
    ...
    try:       
        ...
        for file in mfileList:
            print(file)
        if arcpy.Exists(r"D:\data\covid\capstoneStates.gdb\novCapstoneStates"):
            arcpy.Delete_management(r"D:\data\covid\capstoneStates.gdb\novcapStates")
            print("Exists D:\data\covid\capstoneStates.gdb\novcapstoneStates",arcpy.Exists(r"D:\data\covid\capstoneStates.gdb\novcapstoneStates"))
        arcpy.management.Merge(mfileList, r"D:\data\covid\capstoneStates.gdb\novcapstoneStates", '', "NO_SOURCE_INFO")
        arcpy.management.AddIndex(r"D:\data\covid\capstoneStates.gdb\novcapstoneStates", "GEONUM", "GEONUM", "NON_UNIQUE", "NON_ASCENDING")
        patternCount = os.path.join(r"D:\data\covid","patternCount"+tdate+".csv")
