...
def splitDatabyDay():
    try:
        ...
        arcpy.env.workspace = r"D:\data\covid\cases\nov2020\nov2020.gdb"
        arcTables = arcpy.ListTables()# get list of tables
        coCounties = r"D:\data\covid\cases\nov2020\nov2020.gdb\ctyPrj" # variable for USA_Counties # variable for USA_Counties
        ...
        for root, dirs, files in os.walk(newfolder):
            ...
            for filename in fileGlob: # for file in fileGlob
                ...
                try:
                    ...
                    #arcpy.stpm.EmergingHotSpotAnalysis(netCDFTable, "PERDAY_NONE_ZEROS", EHSA, None, 7, None, "CONTIGUITY_EDGES_CORNERS", 8, "NEIGHBORHOOD_TIME_STEP")
                    arcpy.stpm.EmergingHotSpotAnalysis(netCDFTable, "PERDAY_NONE_ZEROS", EHSA, None, 7, None, "CONTIGUITY_EDGES_CORNERS", 8, "NEIGHBORHOOD_TIME_STEP")
...
def combinePatternCount():
    ...
    try:       
        ...
        pdf2.to_csv(os.path.join(r"D:\data\covid\cases\nov2020","patternEHSA"+tdate+".csv"), sep = ',', index = None, header = 1)     
        ...
        tsdf2.to_csv(os.path.join(r"D:\data\covid\cases\nov2020","time_series"+tdate+".csv"), sep = ',', index = None, header = 1)     
...
tdate=dt.datetime.strftime(dt.date.today(),'%Y%m%d')
fullDS = r"D:\data\covid\cases\nov2020\\"+"UgnAll_series"+tdate+".csv"
stateDS = r"D:\data\covid\cases\nov2020\\"+"Ugntime_series"+tdate+".csv"
currDaystatefile=os.path.join(r"D:\data\covid\cases\nov2020","_time_series"+tdate+".csv")
...
#        pdf = pd.read_csv(r'D:\data\covid\cases\nov2020\patternEHSA20210112.csv')
#        tsdf = pd.read_csv(r'D:\data\covid\cases\nov2020\time_series20210112.csv')  
...
#        patternCount = os.path.join(r"D:\data\covid\cases\nov2020","patternCount.csv")
#        new_df.to_csv(patternCount, sep = ',', index = None, header = 1)
#        newtsdf.to_csv(os.path.join(r"D:\data\covid\cases\nov2020","time_series.csv"), sep = ',', index = None, header = 1)
#        pdf.to_csv(os.path.join(r"D:\data\covid\cases\nov2020","patternEHSA.csv"), sep = ',', index = None, header = 1)
    except:
        getTraceback()
